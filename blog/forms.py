...
class BlogForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput( attrs={ 'placeholder': 'A short, specific title', "autofocus": True}),
    ...
    def clean_content(self):
        ...
        if title and author:
            ...
            if self.instance.pk:
                # Editing: a post is allowed to keep its title if it is the same post being edited
